...
goog.base = function(a, b, c) {
	...
	if (d.superClass_) {
		for (var e = Array(arguments.length - 1),
	...
	for ( f = 2; f < arguments.length; f++)
		e[f - 2] = arguments[f];
	for (var f = !1,
	    g = a.constructor; g; g = g.superClass_ && g.superClass_.constructor)
		if (g.prototype[b] === d)
			f = !0;
		else if (f)
...
goog.string.numerateCompare = function(a, b) {
	...
	if (!b)
		return 1;
	for (var c = a.toLowerCase().match(goog.string.numerateCompareRegExp_),
	...
	for (var c = 0,
		...
		do {
			...
			var c = 0 == n[1].length ? 0 : parseInt(n[1], 10),
			    r = 0 == q[1].length ? 0 : parseInt(q[1], 10),
			    c = goog.string.compareElements_(c, r) || goog.string.compareElements_(0 == n[2].length, 0 == q[2].length) || goog.string.compareElements_(n[2], q[2])
		} while(0==c)
	}
	return c
};
...
goog.array.binarySelect = function(a, b, c) {
	return goog.array.binarySearch_(a, b, !0,
	void 0, c)
};
...
goog.array.compare3 = function(a, b, c) {
	...
	for (var d = Math.min(a.length, b.length),
	    e = 0; e < d; e++) {
		var f = c(a[e], b[e]);
		if (0 != f)
			return f
...
goog.object.getValueByKeys = function(a, b) {
	for (var c = goog.isArrayLike(b),
	    d = c ? b : arguments,
	    c = c ? 0 : 1; c < d.length && ( a = a[d[c]], goog.isDef(a)); c++);
	return a
};
...
goog.userAgent.DOCUMENT_MODE = function() {
	var a = goog.global.document;
	return a && goog.userAgent.IE ? goog.userAgent.getDocumentMode_() || ("CSS1Compat" == a.compatMode ? parseInt(goog.userAgent.VERSION, 10) : 5) :
	void 0
}();
...
goog.html.SafeStyle.create = function(a) {
	...
	for (c in a) {
		...
		var d = a[c];
		null != d && ( d instanceof goog.string.Const ? ( d = goog.string.Const.unwrap(d), goog.asserts.assert(!/[{;}]/.test(d), "Value does not allow [{;}].")) : goog.html.SafeStyle.VALUE_RE_.test(d) || (goog.asserts.fail("String value allows only [-.%_!# a-zA-Z0-9], got: " + d),
		d = goog.html.SafeStyle.INNOCUOUS_STRING), b += c + ":" + d + ";")
	}
	if (!b)
		return goog.html.SafeStyle.EMPTY;
...
goog.i18n.bidi.guardBracketInHtml = function(a, b) {
	return (
	void 0 === b ? goog.i18n.bidi.hasAnyRtl(a) : b) ? a.replace(goog.i18n.bidi.bracketGuardHtmlRe_, "<span dir=rtl>$&</span>") : a.replace(goog.i18n.bidi.bracketGuardHtmlRe_, "<span dir=ltr>$&</span>")
};
goog.i18n.bidi.guardBracketInText = function(a, b) {
	var c = (
	void 0 === b ? goog.i18n.bidi.hasAnyRtl(a) : b) ? goog.i18n.bidi.Format.RLM : goog.i18n.bidi.Format.LRM;
...
goog.i18n.bidi.estimateDirection = function(a, b) {
	for (var c = 0,
	    d = 0,
	    e = !1,
	    f = goog.i18n.bidi.stripHtmlIfNeeded_(a, b).split(goog.i18n.bidi.wordSeparatorRe_),
	    g = 0; g < f.length; g++) {
		var h = f[g];
...
goog.html.SafeHtml.concat = function(a) {
	var b = goog.i18n.bidi.Dir.NEUTRAL,
	    c = "",
	    d = function(a) {
		goog.isArray(a) ? goog.array.forEach(a, d) : ( a = goog.html.SafeHtml.htmlEscape(a), c += goog.html.SafeHtml.unwrap(a),
		a = a.getDirection(), b == goog.i18n.bidi.Dir.NEUTRAL ? b = a : a != goog.i18n.bidi.Dir.NEUTRAL && b != a && ( b = null))
	};
...
goog.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse = function(a, b, c) {
	...
	goog.dom.tags.isVoidTag(a.toLowerCase()) ? (goog.asserts.assert(!c.length, "Void tag <" + a + "> does not allow content."), e += ">") : ( d = goog.html.SafeHtml.concat(c), e += ">" + goog.html.SafeHtml.unwrap(d) + "</" + a + ">",
	d = d.getDirection());
...
goog.dom.getChildren = function(a) {
	...
	void 0 != a.children ? a.children : goog.array.filter(a.childNodes, function(a) {
		return a.nodeType == goog.dom.NodeType.ELEMENT
	})
};
goog.dom.getFirstElementChild = function(a) {
	return
	void 0 != a.firstElementChild ? a.firstElementChild : goog.dom.getNextElementNode_(a.firstChild, !0)
};
goog.dom.getLastElementChild = function(a) {
	return
	void 0 != a.lastElementChild ? a.lastElementChild : goog.dom.getNextElementNode_(a.lastChild, !1)
};
goog.dom.getNextElementSibling = function(a) {
	return
	void 0 != a.nextElementSibling ? a.nextElementSibling : goog.dom.getNextElementNode_(a.nextSibling, !0)
};
goog.dom.getPreviousElementSibling = function(a) {
	return
	void 0 != a.previousElementSibling ? a.previousElementSibling : goog.dom.getNextElementNode_(a.previousSibling, !1)
};
...
goog.dom.getNodeAtOffset = function(a, b, c) {
	...
	goog.isObject(c) && (c.remainder = e ? e.nodeValue.length + b - d - 1 : 0, c.node =
	e);
	return e
};
...
goog.events.ListenerMap.prototype.add = function(a, b, c, d, e) {
	...
	-1 < g ? ( b = a[g], c || (b.callOnce = !1)) : ( b = new goog.events.Listener(b, null, this.src, f, !!d, e), b.callOnce =
	c, a.push(b));
	return b
};
goog.events.ListenerMap.prototype.remove = function(a, b, c, d) {
	...
	return -1 < b ? (e[b].markAsRemoved(), goog.array.removeAt(e, b), 0 == e.length && (
	delete this.listeners[a], this.typeCount_--), !0) : !1
};
goog.events.ListenerMap.prototype.removeByKey = function(a) {
	...
	c && (a.markAsRemoved(), 0 == this.listeners[b].length && (
...
goog.events.removeAll = function(a, b) {
	...
	if (!e || f == e)
		for (var g = c.listeners[f].concat(),
		    h = 0; h < g.length; ++h)
...
goog.math.Box.boundingBox = function(a) {
	for (var b = new goog.math.Box(arguments[0].y, arguments[0].x, arguments[0].y, arguments[0].x),
...
goog.math.Rect.prototype.intersection = function(a) {
	...
	if (b <= c) {
		...
		if (d <= a)
			return this.left = b, this.top =
			d, this.width = c - b, this.height = a - d, !0
	}
	return !1
};
...
goog.style.getVendorStyleName_ = function(a, b) {
	var c = goog.string.toCamelCase(b);
	return
	void 0 === a.style[c] && ( c = goog.dom.vendor.getVendorJsPrefix() + goog.string.toTitleCase(c),
...
goog.style.setPosition = function(a, b, c) {
	var d,
	    e = goog.userAgent.GECKO && (goog.userAgent.MAC || goog.userAgent.X11) && goog.userAgent.isVersionOrHigher("1.9");
...
goog.style.getOffsetParent = function(a) {
	...
	for ( a = a.parentNode; a && a != b; a = a.parentNode)
		if ( c = goog.style.getStyle_(a, "position"),
...
goog.style.getVisibleRectForElement = function(a) {
	for (var b = new goog.math.Box(0, Infinity, Infinity, 0),
	    c = goog.dom.getDomHelper(a),
	    d = c.getDocument().body,
	    e = c.getDocument().documentElement,
	    f = c.getDocumentScrollElement(); a = goog.style.getOffsetParent(a); )
...
goog.style.getPageOffset = function(a) {
	...
	if (goog.style.GET_BOUNDING_CLIENT_RECT_ALWAYS_EXISTS || a.getBoundingClientRect)
		...
		a = goog.dom.getDomHelper(c).getDocumentScroll(), f.x = b.left + a.x, f.y = b.top + a.y;
	else if (c.getBoxObjectFor && !e)
		b = c.getBoxObjectFor(a),
		a = c.getBoxObjectFor(g), f.x = b.screenX - a.screenX, f.y = b.screenY - a.screenY;
	else {
		b = a;
		do {
			f.x += b.offsetLeft;
...
goog.style.getClientPositionForElement_ = function(a) {
	...
	if (goog.style.GET_BOUNDING_CLIENT_RECT_ALWAYS_EXISTS || a.getBoundingClientRect)
		b = goog.style.getBoundingClientRect_(a),
		b = new goog.math.Coordinate(b.left, b.top);
	else {
...
goog.style.installStyles = function(a, b) {
	var c = goog.dom.getDomHelper(b),
	    d = null,
	    e = c.getDocument();
	goog.userAgent.IE && e.createStyleSheet ? ( d = e.createStyleSheet(), goog.style.setStyles(d, a)) : ( e = c.getElementsByTagNameAndClass("head")[0], e || ( d = c.getElementsByTagNameAndClass("body")[0],
	e = c.createDom("head"), d.parentNode.insertBefore(e, d)),
	d = c.createDom("style"), goog.style.setStyles(d, a), c.appendChild(e, d));
	return d
};
...
goog.style.getContentBoxSize = function(a) {
	...
	if (c && goog.dom.getDomHelper(b).isCss1CompatMode() && "auto" != c.width && "auto" != c.height && !c.boxSizing)
		...
		a = goog.style.getIePixelValue_(a, c.height, "height", "pixelHeight"), new goog.math.Size(b, a);
...
goog.style.getFontSize = function(a) {
	...
	if (goog.userAgent.IE) {
		...
		if (a.parentNode && a.parentNode.nodeType == goog.dom.NodeType.ELEMENT && c in goog.style.CONVERTIBLE_RELATIVE_CSS_UNITS_)
			...
			c = goog.style.getStyle_(a, "fontSize"), goog.style.getIePixelValue_(a, b == c ? "1em" : b, "left", "pixelLeft")
	}
...
goog.events.EventTarget.dispatchEventInternal_ = function(a, b, c) {
	...
	e = f.fireListeners(d, !0, b) && e, b.propagationStopped_ || ( e = f.fireListeners(d, !1, b) && e));
	if (c)
...
goog.ui.Component.prototype.addChildAt = function(a, b, c) {
	...
	b = c.childNodes[b] || null, b != a.getElement() && c.insertBefore(a.getElement(), b)) : c ? (this.element_ || this.createDom(),
	b = this.getChildAt(b + 1), a.render_(this.getContentElement(), b ? b.element_ : null)) : this.inDocument_ && !a.inDocument_ && a.element_ && a.element_.parentNode && a.element_.parentNode.nodeType == goog.dom.NodeType.ELEMENT && a.enterDocument()
};
...
goog.events.KeyHandler.prototype.handleEvent = function(a) {
	...
	d = c != goog.events.KeyCodes.ENTER && c != goog.events.KeyCodes.ESC ? b.keyCode : 0) : goog.userAgent.WEBKIT && a.type == goog.events.EventType.KEYPRESS ? ( c = this.keyCode_,
	d = 0 <= b.charCode && 63232 > b.charCode && goog.events.KeyCodes.isCharacterKey(c) ? b.charCode : 0) : goog.userAgent.OPERA ? ( c = this.keyCode_,
...
goog.a11y.aria.setState = function(a, b, c) {
	...
	"" === c ||
	void 0 == c ? ( c = goog.a11y.aria.datatables.getDefaultValuesMap(), b in c ? a.setAttribute(d, c[b]) : a.removeAttribute(d)) : a.setAttribute(d, c)
};
...
goog.ui.ControlRenderer.prototype.updateAriaState = function(a, b, c) {
	...
	goog.asserts.assert(a, "The element passed as a first parameter cannot be null.");
	( b = goog.ui.ControlRenderer.getAriaStateForAriaRole_(a, goog.ui.ControlRenderer.ARIA_ATTRIBUTE_MAP_[b])) && goog.a11y.aria.setState(a, b, c)
};
...
goog.ui.registry.getDecorator = function(a) {
	goog.asserts.assert(a);
	for (var b = goog.dom.classlist.get(a),
	    c = 0,
	    d = b.length; c < d; c++)
...
goog.iter.starMap = function(a, b, c) {
	...
	a.next = function() {
		...
		return b.apply(c, goog.array.concat(a,
		void 0, d))
	};
	return a
};
...
goog.ui.PaletteRenderer.prototype.findAriaLabelForCell_ = function(a) {
	...
	for (var b = "",
	    c; !b && ( c = goog.iter.nextOrValue(a, null)); )
		...
		if (c) {
			...
			if (d < b.length) {
				for (var e = [],
				    ...
				    g = c.rows[0].cells.length; d < b.length; ) {
					var h = b[d++];
...
goog.ui.PaletteRenderer.prototype.getContainingItem = function(a, b) {
	for (var c = a.getElement(); b && b.nodeType == goog.dom.NodeType.ELEMENT && b != c; ) {
		if (b.tagName == goog.dom.TagName.TD && goog.dom.classlist.contains(b, this.getCssClass() + "-cell"))
			return b.firstChild;
		b = b.parentNode
	}
	return null
...
goog.ui.SelectionModel.prototype.setSelectedItem = function(a) {
	a != this.selectedItem_ && (this.selectItem_(this.selectedItem_, !1), this.selectedItem_ =
	a, this.selectItem_(a, !0));
...
goog.ui.Palette.prototype.setHighlightedIndex = function(a) {
	a != this.highlightedIndex_ && (this.highlightIndex_(this.highlightedIndex_, !1), this.lastHighlightedIndex_ = this.highlightedIndex_, this.highlightedIndex_ =
	a, this.highlightIndex_(a, !0), this.dispatchEvent(goog.ui.Palette.EventType.AFTER_HIGHLIGHT))
};
...
window.goog || alert("Error: Closure not found.  Read this:\nhttp://code.google.com/p/blockly/wiki/Closure\n");
var Blockly = {
	pathToBlockly : "./",
...
Blockly.svgResize = function() {
	var a = Blockly.svg.parentNode.offsetWidth,
	    b = Blockly.svg.parentNode.offsetHeight;
	Blockly.svg.cachedWidth_ != a && (Blockly.svg.setAttribute("width", a + "px"), Blockly.svg.cachedWidth_ =
	a);
	Blockly.svg.cachedHeight_ != b && (Blockly.svg.setAttribute("height", b + "px"), Blockly.svg.cachedHeight_ =
	b);
	a = Blockly.svg.getBoundingClientRect();
	Blockly.svg.cachedLeft_ = a.left;
	Blockly.svg.cachedTop_ = a.top
};
Blockly.onMouseDown_ = function(a) {
	...
	if (Blockly.isRightButton(a))
		Blockly.ContextMenu && Blockly.showContextMenu_(a.clientX, a.clientY);
	else if (!Blockly.editable || b)
...
Blockly.loadAudio_ = function(a) {
	if (window.Audio) {
		...
		b && b.play && (b.play(), b.volume = 0, Blockly.SOUNDS_[a] =
		b)
	}
};
Blockly.playAudio = function(a) {
	if ( a = Blockly.SOUNDS_[a])
		a.volume = 1, a.play()
};
...
Blockly.Block.terminateDrag_ = function() {
	...
	if (2 == Blockly.Block.dragMode_ && Blockly.selected) {
...
Blockly.Block.prototype.dispose = function(a, b) {
	if (this.outputConnection)
		...
		if (a && this.nextConnection && this.nextConnection.targetConnection) {
			var d = this.nextConnection.targetConnection,
			    e = this.nextConnection.targetBlock();
	...
	for ( c = this.childBlocks_.length - 1; 0 <= c; c--)
	...
	for ( c = 0; c < d.length; c++)
		e = d[c], e.targetConnection && e.disconnect(), d[c].dispose();
...
Blockly.Block.prototype.onMouseDown_ = function(a) {
	...
	if (Blockly.isRightButton(a))
		Blockly.ContextMenu && this.showContextMenu_(a.clientX, a.clientY);
...
Blockly.Block.prototype.onMouseUp_ = function(a) {
	...
	if (Blockly.selected && Blockly.highlightedConnection_)
		Blockly.localConnection_.connect(Blockly.highlightedConnection_), this.svg_ && (Blockly.localConnection_.isSuperior() ? Blockly.highlightedConnection_ : Blockly.localConnection_).sourceBlock_.svg_.connectionUiEffect(), this.workspace.trashcan && this.workspace.trashcan.isOpen && Blockly.Trashcan.close(this.workspace.trashcan);
	else if (this.workspace.trashcan && this.workspace.trashcan.isOpen) {
		var b = this.workspace.trashcan;
		window.setTimeout(function() {
			Blockly.Trashcan.close(b)
		}, 100);
...
Blockly.Block.prototype.showContextMenu_ = function(a, b) {
	if (this.contextMenu) {
		...
		if (this.deletable) {
			...
			c.nextConnection && c.nextConnection.targetConnection && (e -= this.nextConnection.targetBlock().getDescendants().length);
			e = {
				text : 1 == e ? Blockly.MSG_DELETE_BLOCK : Blockly.MSG_DELETE_X_BLOCKS.replace("%1", e),
				enabled : !0,
				callback : function() {
					c.dispose(!0, !0)
				}
...
Blockly.Block.prototype.moveConnections_ = function(a, b) {
	if (this.rendered) {
		for (var c = this.getConnections_(!1),
		    d = 0; d < c.length; d++)
			c[d].moveBy(a, b);
...
Blockly.Block.prototype.onMouseMove_ = function(a) {
	if ("mousemove" != a.type || 1 != a.x || 0 != a.y || 0 != a.button) {
		...
		if (2 == Blockly.Block.dragMode_) {
			...
			for (var e = this.getConnections_(!1),
			    f = null,
			    g = null,
			...
			f && f != Blockly.highlightedConnection_ && (f.highlight(), Blockly.highlightedConnection_ =
...
Blockly.Block.prototype.bumpNeighbours_ = function() {
	for (var a = this.getRootBlock(),
	    b = this.getConnections_(!1),
	    c = 0; c < b.length; c++) {
		var d = b[c];
		d.targetConnection && d.isSuperior() && d.targetBlock().bumpNeighbours_();
		for (var e = d.neighbours_(Blockly.SNAP_RADIUS),
		    f = 0; f < e.length; f++) {
			var g = e[f];
...
Blockly.Block.prototype.setParent = function(a) {
	...
	b = this.getRelativeToSurfaceXY(), a.svg_ && this.svg_ && a.svg_.getRootElement().appendChild(this.svg_.getRootElement()),
	a = this.getRelativeToSurfaceXY(), this.moveConnections_(a.x - b.x, a.y - b.y)) : this.workspace.addTopBlock(this)
};
Blockly.Block.prototype.getDescendants = function() {
	for (var a = [this],
	    b,
	    c = 0; b = this.childBlocks_[c]; c++)
...
Blockly.Block.prototype.setNextStatement = function(a, b) {
	...
	a && (
	void 0 === b && ( b = null), this.nextConnection = new Blockly.Connection(this, Blockly.NEXT_STATEMENT), this.nextConnection.setCheck(b));
	this.rendered && (this.render(), this.bumpNeighbours_())
};
...
Blockly.Block.prototype.setCollapsed = function(a) {
	if (this.collapsed != a) {
		for (var b = (this.collapsed = a) ? "none" : "block",
		    c = [],
		    d = 0,
		    e; e = this.inputList[d]; d++) {
			for (var f = 0,
			    g; g = e.titleRow[f]; f++)
				(g.getRootElement ? g.getRootElement() : g).style.display = b;
			e.connection && ( a ? e.connection.hideAll() : c = c.concat(e.connection.unhideAll()),
			e = e.connection.targetBlock()) && (e.svg_.getRootElement().style.display = b, a && (e.rendered = !1))
		}
		a && this.mutator && this.mutator.setVisible(!1);
		a && this.comment && this.comment.setVisible(!1);
		a && this.warning && this.warning.setVisible(!1);
		0 == c.length && (c[0] = this);
		if (this.rendered) {
			for ( d = 0; a = c[d]; d++)
				a.render();
...
Blockly.Block.prototype.setMutator = function(a) {
	...
	a && (a.block_ = this, this.mutator =
	a, this.svg_ && a.createIcon())
};
...
Blockly.Block.prototype.setCommentText = function(a) {
	...
	b = !0), this.comment.setText(a)) : this.comment && (this.comment.dispose(),
	b = !0);
...
Blockly.Block.prototype.setWarningText = function(a) {
	...
	b = !0), this.warning.setText(a)) : this.warning && (this.warning.dispose(),
	b = !0);
	this.rendered && (this.render(), b && this.bumpNeighbours_())
};
...
Blockly.BlockSvg = function(a) {
	...
	a.editable && Blockly.addClass_(this.svgGroup_, "blocklyDraggable")
};
...
Blockly.BlockSvg.prototype.updateDisabled = function() {
	...
	for (var a = this.block_.getChildren(),
	    b = 0,
	    c; c = a[b]; b++)
...
Blockly.BlockSvg.prototype.renderCompute_ = function(a) {
	...
	void 0,
	    ...
	    m; m = b[l]; l++) {
		var n;
		this.block_.inputsInline && k && k != Blockly.NEXT_STATEMENT && m.type != Blockly.NEXT_STATEMENT ? n = c[c.length - 1] : ( k = m.type,
		n = [], n.type = this.block_.inputsInline && m.type != Blockly.NEXT_STATEMENT ? Blockly.BlockSvg.INLINE : m.type, n.height = 0, c.push(n));
		n.push(m);
		...
		if (m.connection && m.connection.targetConnection) {
			var q = m.connection.targetBlock().getSvgRoot();
			try {
				var r = q.getBBox()
			} catch(p) {
				r = {
			...
			goog.userAgent.WEBKIT && (r.height -= 3);
			m.renderHeight = Math.max(m.renderHeight, r.height - 1);
		...
		for (var q = 0,
		    t; t = m.titleRow[q]; q++)
			0 != q && (m.titleWidth += Blockly.BlockSvg.SEP_SPACE_X),
			t = t.getSize(), m.titleWidth += t.width, n.height = Math.max(n.height, t.height);
		n.type != Blockly.BlockSvg.INLINE && (n.type == Blockly.NEXT_STATEMENT ? ( g = !0,
		e = Math.max(e, m.titleWidth)) : (n.type == Blockly.INPUT_VALUE ? f = !0 : n.type == Blockly.DUMMY_INPUT && ( h = !0),
		d = Math.max(d, m.titleWidth)))
	}
	for ( a = 0; n = c[a]; a++)
		if (n.thicker = !1, this.block_.inputsInline && n.type == Blockly.BlockSvg.INLINE)
			for ( b = 0; m = n[b]; b++)
				if (m.type == Blockly.INPUT_VALUE) {
					n.height += 2 * Blockly.BlockSvg.SEP_SPACE_Y;
					n.thicker = !0;
					break
				}
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function(a, b, c, d, e, f, g) {
	for (var h,
		...
		if (q.type == Blockly.BlockSvg.INLINE) {
			for (var r = 0,
			    p; p = q[r]; r++)
				l = k + Blockly.BlockSvg.TITLE_HEIGHT, q.thicker && (l += Blockly.BlockSvg.SEP_SPACE_Y),
				h = this.renderTitles_(p.titleRow, h, l), p.type != Blockly.DUMMY_INPUT && (h += p.renderWidth + Blockly.BlockSvg.SEP_SPACE_X), p.type == Blockly.INPUT_VALUE && (c.push("M", h - Blockly.BlockSvg.SEP_SPACE_X + "," + (k + Blockly.BlockSvg.SEP_SPACE_Y)), c.push("h", Blockly.BlockSvg.TAB_WIDTH - p.renderWidth), c.push(Blockly.BlockSvg.TAB_PATH_DOWN), c.push("v", p.renderHeight - Blockly.BlockSvg.TAB_HEIGHT), c.push("h", p.renderWidth - Blockly.BlockSvg.TAB_WIDTH), c.push("z"), Blockly.RTL ? (d.push("M", h - Blockly.BlockSvg.SEP_SPACE_X + Blockly.BlockSvg.TAB_WIDTH - p.renderWidth - 1 + "," + (k + Blockly.BlockSvg.SEP_SPACE_Y + 1)), d.push(Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL), d.push("v", p.renderHeight - Blockly.BlockSvg.TAB_HEIGHT + 2), d.push("h", p.renderWidth - Blockly.BlockSvg.TAB_WIDTH)) : (d.push("M", h - Blockly.BlockSvg.SEP_SPACE_X + 1 + "," + (k + Blockly.BlockSvg.SEP_SPACE_Y + 1)), d.push("v", p.renderHeight), d.push("h", Blockly.BlockSvg.TAB_WIDTH - p.renderWidth), d.push("M", h - p.renderWidth - Blockly.BlockSvg.SEP_SPACE_X + 3.8 + "," + (k + Blockly.BlockSvg.SEP_SPACE_Y + Blockly.BlockSvg.TAB_HEIGHT - .4)), d.push("l", .42 * Blockly.BlockSvg.TAB_WIDTH + ",-1.8")),
				l = Blockly.RTL ? e.x - h - Blockly.BlockSvg.TAB_WIDTH + Blockly.BlockSvg.SEP_SPACE_X + p.renderWidth - 1 : e.x + h + Blockly.BlockSvg.TAB_WIDTH - Blockly.BlockSvg.SEP_SPACE_X - p.renderWidth + 1,
				m = e.y + k + Blockly.BlockSvg.SEP_SPACE_Y, p.connection.moveTo(l, m), p.connection.targetConnection && p.connection.tighten_());
			...
			q.type == Blockly.INPUT_VALUE ? ( p = q[0],
			l = k + Blockly.BlockSvg.TITLE_HEIGHT, p.align != Blockly.ALIGN_LEFT && ( r = f.rightEdge - p.titleWidth - Blockly.BlockSvg.TAB_WIDTH - Blockly.BlockSvg.SEP_SPACE_X, p.align == Blockly.ALIGN_RIGHT ? h = r : p.align == Blockly.ALIGN_CENTRE && ( h = (r + h) / 2)), this.renderTitles_(p.titleRow, h, l), a.push(Blockly.BlockSvg.TAB_PATH_DOWN), a.push("v", q.height - Blockly.BlockSvg.TAB_HEIGHT), Blockly.RTL ? (b.push(Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL), b.push("v", q.height - Blockly.BlockSvg.TAB_HEIGHT)) : (b.push("M", f.rightEdge - 4.2 + "," + (k + Blockly.BlockSvg.TAB_HEIGHT - .4)), b.push("l", .42 * Blockly.BlockSvg.TAB_WIDTH + ",-1.8")),
			l = e.x + (Blockly.RTL ? -f.rightEdge - 1 : f.rightEdge + 1),
			m = e.y + k, p.connection.moveTo(l, m), p.connection.targetConnection && p.connection.tighten_()) : q.type == Blockly.DUMMY_INPUT ? ( p = q[0],
			l = k + Blockly.BlockSvg.TITLE_HEIGHT, p.align != Blockly.ALIGN_LEFT && ( r = f.rightEdge - p.titleWidth - Blockly.BlockSvg.SEP_SPACE_X, f.hasValue && (r -= Blockly.BlockSvg.TAB_WIDTH), p.align == Blockly.ALIGN_RIGHT ? h = r : p.align == Blockly.ALIGN_CENTRE && ( h = (r + h) / 2)), this.renderTitles_(p.titleRow, h, l), a.push("v", q.height), Blockly.RTL && b.push("v", q.height - 2)) : q.type == Blockly.NEXT_STATEMENT && ( p = q[0], 0 == n && (a.push("v", Blockly.BlockSvg.SEP_SPACE_Y), Blockly.RTL && b.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1), k += Blockly.BlockSvg.SEP_SPACE_Y),
			l = k + Blockly.BlockSvg.TITLE_HEIGHT, p.align != Blockly.ALIGN_LEFT && ( r = f.statementEdge - p.titleWidth - Blockly.BlockSvg.SEP_SPACE_X, p.align == Blockly.ALIGN_RIGHT ? h = r : p.align == Blockly.ALIGN_CENTRE && ( h = (r + h) / 2)), this.renderTitles_(p.titleRow, h, l),
			h = f.statementEdge + Blockly.BlockSvg.NOTCH_WIDTH, a.push("H", h), a.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER), a.push("v", q.height - 2 * Blockly.BlockSvg.CORNER_RADIUS), a.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER), a.push("H", f.rightEdge), Blockly.RTL ? (b.push("M", h - Blockly.BlockSvg.NOTCH_WIDTH + Blockly.BlockSvg.DISTANCE_45_OUTSIDE + "," + (k + Blockly.BlockSvg.DISTANCE_45_OUTSIDE)), b.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER_HIGHLIGHT_RTL), b.push("v", q.height - 2 * Blockly.BlockSvg.CORNER_RADIUS), b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_RTL), b.push("H", f.rightEdge - 1)) : (b.push("M", h - Blockly.BlockSvg.NOTCH_WIDTH + Blockly.BlockSvg.DISTANCE_45_OUTSIDE + "," + (k + q.height - Blockly.BlockSvg.DISTANCE_45_OUTSIDE)), b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_LTR), b.push("H", f.rightEdge)),
			l = e.x + (Blockly.RTL ? -h : h),
			m = e.y + k + 1, p.connection.moveTo(l, m), p.connection.targetConnection && p.connection.tighten_(), n == f.length - 1 || f[n + 1].type == Blockly.NEXT_STATEMENT) && (a.push("v", Blockly.BlockSvg.SEP_SPACE_Y), Blockly.RTL && b.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1), k += Blockly.BlockSvg.SEP_SPACE_Y);
		k += q.height
	}
	f.length || (this.block_.collapsed && (a.push(Blockly.BlockSvg.JAGGED_TEETH), Blockly.RTL ? b.push("l 8,0 0,3.8 7,3.2 m -14.5,9 l 8,4") : b.push("h 8")),
...
Blockly.BlockSvg.prototype.renderDrawLeft_ = function(a, b, c, d) {
	this.block_.outputConnection ? (this.block_.outputConnection.moveTo(c.x, c.y), a.push("V", Blockly.BlockSvg.TAB_HEIGHT), a.push("c 0,-10 -" + Blockly.BlockSvg.TAB_WIDTH + ",8 -" + Blockly.BlockSvg.TAB_WIDTH + ",-7.5 s " + Blockly.BlockSvg.TAB_WIDTH + ",2.5 " + Blockly.BlockSvg.TAB_WIDTH + ",-7.5"), Blockly.RTL ? (b.push("M", -.3 * Blockly.BlockSvg.TAB_WIDTH + ",8.9"), b.push("l", -.45 * Blockly.BlockSvg.TAB_WIDTH + ",-2.1")) : (b.push("V", Blockly.BlockSvg.TAB_HEIGHT - 1), b.push("m", -.92 * Blockly.BlockSvg.TAB_WIDTH + ",-1 q " + -.19 * Blockly.BlockSvg.TAB_WIDTH + ",-5.5 0,-11"), b.push("m", .92 * Blockly.BlockSvg.TAB_WIDTH + ",1 V 1 H 2"))) : Blockly.RTL || (this.squareTopLeftCorner_ ? b.push("V", 1) : b.push("V", Blockly.BlockSvg.CORNER_RADIUS));
	a.push("z")
};
Blockly.Bubble = function(a, b, c, d, e, f, g) {
	...
	f = a.width + 2 * Blockly.Bubble.BORDER_WIDTH,
	g = a.height + 2 * Blockly.Bubble.BORDER_WIDTH);
...
Blockly.Bubble.prototype.createDom_ = function(a, b) {
	...
	c = 2 * Blockly.Bubble.BORDER_WIDTH, Blockly.createSvgElement("polygon", {
		points : "0,x x,x x,0".replace(/x/g, c)
...
Blockly.Comment.prototype.setBubbleSize = function(a, b) {
	this.isVisible() ? this.bubble_.setBubbleSize(a, b) : (this.width_ = a, this.height_ =
	b)
};
...
Blockly.Connection.prototype.connect = function(a) {
	...
	var d;
	this.isSuperior() ? ( c = this.sourceBlock_,
	d = a.sourceBlock_) : ( c = a.sourceBlock_,
	d = this.sourceBlock_);
...
Blockly.Connection.prototype.disconnect = function() {
	...
	a = a.sourceBlock_) : ( b = a.sourceBlock_,
	a = this.sourceBlock_);
	b.rendered && b.render();
...
Blockly.Connection.prototype.highlight = function() {
	var a;
	this.type == Blockly.INPUT_VALUE || this.type == Blockly.OUTPUT_VALUE ? ( a = Blockly.RTL ? -Blockly.BlockSvg.TAB_WIDTH : Blockly.BlockSvg.TAB_WIDTH,
	a = "m 0,0 v 5 c 0,10 " + -a + ",-8 " + -a + ",7.5 s " + a + ",-2.5 " + a + ",7.5 v 5") : a = Blockly.RTL ? "m 20,0 h -5 l -6,4 -3,0 -6,-4 h -5" : "m -20,0 h 5 l 6,4 3,0 6,-4 h 5";
...
Blockly.Connection.prototype.setCheck = function(a) {
	a ? ( a instanceof Array || ( a = [a]), this.check_ =
	a, this.targetConnection && !this.checkType_(this.targetConnection) && (this.isSuperior() ? this.targetBlock().setParent(null) : this.sourceBlock_.setParent(null), this.sourceBlock_.bumpNeighbours_())) : this.check_ = null;
	return this
};
Blockly.Connection.prototype.neighbours_ = function(a) {
	...
	for (var c = this.dbList_[Blockly.OPPOSITE_TYPE[this.type]],
	    d = this.x_,
	    e = this.y_,
	    f = 0,
	    g = c.length - 2,
...
Blockly.Connection.prototype.hideAll = function() {
	this.inDB_ && this.dbList_[this.type].removeConnection_(this);
	if (this.targetConnection)
		for (var a = this.targetBlock().getDescendants(),
		    b = 0; b < a.length; b++) {
			for (var c = a[b],
			    d = c.getConnections_(!0),
			    e = 0; e < d.length; e++) {
				var f = d[e];
				f.inDB_ && this.dbList_[f.type].removeConnection_(f)
			}
			c.comment && c.comment.setVisible_(!1)
		}
};
Blockly.Connection.prototype.unhideAll = function() {
	...
	if (b) {
		...
		0 == a.length && (a[0] = b);
		b.comment && b.comment.isPinned() && b.comment.setVisible_(!0)
	}
	return a
};
...
Blockly.ContextMenu.show = function(a, b, c) {
	if (0 == c.length)
		...
		for (var d = 0,
		    e = [Blockly.ContextMenu.svgBackground, Blockly.ContextMenu.svgShadow],
		    f = 0,
		    g; g = c[f]; f++) {
			...
			e.push(k);
			Blockly.bindEvent_(h, "mousedown", null, Blockly.noEvent);
			...
			d = Math.max(d, l.getComputedTextLength())
		}
		d += 2 * Blockly.ContextMenu.X_PADDING;
		for ( f = 0; f < e.length; f++)
			e[f].setAttribute("width", d);
		if (Blockly.RTL)
			for ( f = 0; h = Blockly.ContextMenu.svgOptions.childNodes[f]; f++)
				l = h.lastChild, l.setAttribute("text-anchor", "end"), l.setAttribute("x", d - Blockly.ContextMenu.X_PADDING);
		Blockly.ContextMenu.svgBackground.setAttribute("height", c.length * Blockly.ContextMenu.Y_HEIGHT + 8);
...
Blockly.Field.prototype.init = function(a) {
	...
	a.getSvgRoot().appendChild(this.group_);
...
Blockly.Field.prototype.render_ = function() {
	if (Blockly.Field.textLengthCache.hasOwnProperty(this.text_))
		var a = Blockly.Field.textLengthCache[this.text_];
	else
		( a = this.textElement_.getComputedTextLength()) && (Blockly.Field.textLengthCache[this.text_] = a);
...
Blockly.Field.prototype.setText = function(a) {
	...
	a = "string" === typeof a ? document.createTextNode(a) : document.createTextNode(a.name);
...
Blockly.FieldDropdown.prototype.showEditor_ = function() {
	function a(a) {
		return function(b) {
			this.changeHandler_ ? this.changeHandler_(a) : this.setText(a);
			b.stopPropagation()
		}
	}
	...
	for (var f = 0,
	    ...
	    l = 0; l < k.length; l++) {
		var m = k[l][0],
		    n = Blockly.ContextMenu.optionToDom(m),
		    q = n.firstChild,
		    r = n.lastChild;
		c.appendChild(n);
		h || m != this.text_ || ( h = Blockly.createSvgElement("text", {
			"class" : "blocklyMenuText",
			y : 15
		}, null), n.insertBefore(h, r), h.appendChild(document.createTextNode("\u2713")));
...
Blockly.FieldDropdown.prototype.getValue = function() {
	for (var a = this.text_,
	    b = this.getOptions_(),
	    c = 0; c < b.length; c++)
		if (b[c][0] == a)
			return b[c][1];
	throw '"' + a + '" not valid in dropdown.';
};
Blockly.FieldDropdown.prototype.setValue = function(a) {
	for (var b = this.getOptions_(),
	    c = 0; c < b.length; c++)
		if (b[c][1] == a) {
			this.setText(b[c][0]);
			return
...
Blockly.FieldCheckbox = function(a) {
	...
	this.checkElement_.appendChild(b);
	this.setValue(a)
};
...
Blockly.FieldColour = function(a) {
	Blockly.Field.call(this, "\u00a0\u00a0\u00a0");
...
Blockly.FieldColour.prototype.showEditor_ = function() {
	...
	var a = new goog.ui.ColorPicker.createSimpleColorGrid;
	...
	Blockly.widgetDiv.style.left = b.x + "px";
...
Blockly.FieldImage.prototype.setText = function(a) {
	this.src_ = a;
	this.imageElement_.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", a)
};
...
Blockly.FieldTextInput.prototype.showEditor_ = function() {
	if (window.opera) {
		...
		this.validationFunc_ && ( a = this.validationFunc_(a));
...
Blockly.FieldTextInput.prototype.validate_ = function() {
	...
	this.validationFunc_ && ( a = this.validationFunc_(b.value));
	a ? Blockly.removeClass_(b, "blocklyInvalidInput") : Blockly.addClass_(b, "blocklyInvalidInput")
};
...
Blockly.FieldTextInput.prototype.closeEditor_ = function(a) {
	...
	a ? ( a = b.value, this.validationFunc_ && ( a = this.validationFunc_(a), null === a && ( a = b.defaultValue))) : a = b.defaultValue;
	this.setText(a);
	Blockly.FieldTextInput.disposeDom_();
	this.sourceBlock_.render()
};
Blockly.FieldVariable = function(a) {
	Blockly.FieldDropdown.call(this, Blockly.FieldVariable.dropdownCreate, Blockly.FieldVariable.dropdownChange);
	a ? this.setText(a) : this.setText(Blockly.Variables.generateUniqueName())
};
...
function findById(a, b) {
	for (var c = 0; c < a.length; c++)
		if (a[c] === b || "object" === typeof a[c] && a[c].name === b)
			return c;
	return -1
}
Blockly.FieldVariable.dropdownCreate = function() {
	var a = Blockly.Variables.allVariables(),
	    b = this.getText();
	b && -1 == findById(a, b) && a.push(b.name);
	a.sort(function(a, b) {
	...
	for (var b = [],
	    c = 0; c < a.length; c++)
		b[c] = "string" === typeof a[c] ? [a[c], a[c]] : [a[c].name, a[c]];
	return b
};
Blockly.FieldVariable.dropdownChange = function(a) {
	...
	if (a == Blockly.MSG_RENAME_VARIABLE) {
		...
		a == Blockly.MSG_NEW_VARIABLE && ( a = b(Blockly.MSG_NEW_VARIABLE_TITLE, ""), Blockly.Variables.renameVariable(a, a)), a && this.setText(a);
...
Blockly.Flyout.prototype.init = function(a, b, c) {
	this.targetWorkspace_ = a;
	this.targetWorkspaceMetrics_ = b;
	this.height_ = this.width_ = 0;
	var d = this;
	c && (this.scrollbar_ = new Blockly.Scrollbar(this.svgOptions_, function() {
		return d.getMetrics()
	}, function(a) {
		return d.setMetrics(a)
	}, !1, !1));
	this.buttons_ = [];
	this.position_();
	this.hide();
...
Blockly.Flyout.prototype.hide = function() {
	...
	for (var a = this.workspace_.getTopBlocks(!1),
	    b = 0,
	    c; c = a[b]; b++)
		c.dispose(!1, !1);
	for ( b = 0; a = this.buttons_[b]; b++)
		Blockly.unbindEvent_(a.wrapper_), goog.dom.removeNode(a);
	this.buttons_ = []
};
Blockly.Flyout.prototype.show = function(a) {
	...
	var c = [],
	    d = [];
	if (a == Blockly.MSG_VARIABLE_CATEGORY)
		Blockly.Variables.flyoutCategory(c, d, b, this.workspace_);
	else if (a == Blockly.MSG_PROCEDURE_CATEGORY)
		Blockly.Procedures.flyoutCategory(c, d, b, this.workspace_);
	else
		for (var e = 0,
		    f; f = a[e]; e++)
			f = new Blockly.Block(this.workspace_, f), f.initSvg(), c[e] =
			f, d[e] = 2 * b;
	a = 0;
	for (var g = b,
	    e = 0; f = c[e]; e++) {
		f.isInFlyout = !0;
		Blockly.Comment && f.setCommentText(null);
		f.render();
		var h = f.getSvgRoot().getBBox();
		f.moveBy(Blockly.RTL ? 0 : b + Blockly.BlockSvg.TAB_WIDTH, g);
		a = Math.max(a, h.width);
		g += h.height + d[e];
		Blockly.bindEvent_(f.getSvgRoot(), "mousedown", null, Blockly.Flyout.createBlockFunc_(this, f))
	}
	a += b + Blockly.BlockSvg.TAB_WIDTH + b / 2 + Blockly.Scrollbar.scrollbarThickness;
	for ( e = 0; f = c[e]; e++)
		Blockly.RTL && f.moveBy(a - b - Blockly.BlockSvg.TAB_WIDTH, 0),
		h = f.getSvgRoot().getBBox(),
		d = f.getRelativeToSurfaceXY(),
		d = Blockly.createSvgElement("rect", {
			width : h.width,
			height : h.height,
			x : d.x + h.x,
			y : d.y + h.y,
			"fill-opacity" : 0
		}, null), this.svgOptions_.insertBefore(d, this.svgOptions_.firstChild), d.wrapper_ = Blockly.bindEvent_(d, "mousedown", null, Blockly.Flyout.createBlockFunc_(this, f)), this.buttons_[e] =
		d;
	this.width_ = a;
	Blockly.fireUiEvent(window, "resize")
};
...
Blockly.Generator.workspaceToCode = function(a) {
	...
	a.init();
	for (var c = Blockly.mainWorkspace.getTopBlocks(!0),
	    d = 0,
	    e; e = c[d]; d++) {
...
Blockly.CodeGenerator.prototype.valueToCode = function(a, b, c) {
	b = a.getInputTargetBlock(b);
	if (!b)
		return "";
	a = this.blockToCode(b);
	if ("" === a)
		return "";
	if (!( a instanceof Array))
		throw 'Expecting tuple from value block "' + b.type + '".';
	b = a[0];
	a = a[1];
	b && c <= a && ( b = "(" + b + ")");
	return b
...
Blockly.createDom_ = function(a) {
	...
	Blockly.Toolbox && Blockly.editable && b.appendChild(Blockly.Toolbox.createDom());
	Blockly.Tooltip && b.appendChild(Blockly.Tooltip.createDom());
	Blockly.editable && b.appendChild(Blockly.FieldDropdown.createDom());
	Blockly.ContextMenu && b.appendChild(Blockly.ContextMenu.createDom());
	a.appendChild(b);
	Blockly.svg = b;
	Blockly.svgResize();
...
Blockly.init_ = function() {
	...
	Blockly.mainWorkspace.scrollbar = new Blockly.ScrollbarPair(Blockly.mainWorkspace.getBubbleCanvas(), Blockly.getMainWorkspaceMetrics, Blockly.setMainWorkspaceMetrics);
...
Blockly.Input.prototype.appendTitle = function(a, b) {
	...
	"object" === typeof a && (a.name = b, this.titleRow.push(a));
...
Blockly.Mutator.prototype.createIcon = function() {
	...
	if (!Blockly.Mutator.crossPath_) {
		...
		b.push("v", -2 * a, "h", -2 * a);
		b.push("v", -a, "z");
		Blockly.Mutator.crossPath_ = b.join(" ")
	}
...
Blockly.Mutator.prototype.resizeBubble_ = function() {
	...
	if (Math.abs(this.workspaceWidth_ - d) > a || Math.abs(this.workspaceHeight_ - b) > a)
		this.workspaceWidth_ = d, this.workspaceHeight_ =
		b, this.bubble_.setBubbleSize(d + a, b + a), this.svgDialog_.setAttribute("width", this.workspaceWidth_), this.svgDialog_.setAttribute("height", this.workspaceHeight_);
...
Blockly.Mutator.prototype.workspaceChanged_ = function() {
	if (0 == Blockly.Block.dragMode_)
		for (var a = this.workspace_.getTopBlocks(!1),
			...
			(0 > d.y || (Blockly.RTL ? d.x > -this.flyout_.width_ : d.x < this.flyout_.width_)) && c.dispose(!1, !1)
		}
	this.rootBlock_.workspace == this.workspace_ && ( a = this.block_.rendered, this.block_.rendered = !1, this.block_.compose(this.rootBlock_), this.block_.rendered =
	a, this.block_.rendered && this.block_.render(), this.resizeBubble_(), this.block_.workspace.fireChangeEvent())
};
...
Blockly.Names.prototype.getName = function(a, b) {
	var c = Blockly.Names.PREFIX_ + a.toLowerCase() + "X" + b;
	if ( c in this.db_)
		return this.db_[c];
...
Blockly.Names.prototype.getDistinctName = function(a, b) {
	for (var c = this.safeName_(a),
	    d = ""; this.dbReverse_[Blockly.Names.PREFIX_ + c + d] || Blockly.Names.PREFIX_ + c + d in this.reservedDict_; )
		d = d ? d + 1 : 2;
	c += d;
	"string" === typeof a ? this.db_[Blockly.Names.PREFIX_ + a.toLowerCase() + "X" + b] = c : this.db_[Blockly.Names.PREFIX_ + a.name.toLowerCase() + "X" + b] = c;
	this.dbReverse_[Blockly.Names.PREFIX_ + c] = !0;
	return c
};
Blockly.Names.prototype.safeName_ = function(a) {
	a ? ( a = "string" === typeof a ? encodeURI(a.replace(/ /g, "_")).replace(/[^\w]/g, "_") : encodeURI(a.name.replace(/ /g, "_")).replace(/[^\w]/g, "_"), -1 != "0123456789".indexOf(a[0]) && ( a = "my_" + a)) : a = "unnamed";
	return a
};
...
Blockly.Procedures.allProcedures = function() {
	for (var a = Blockly.mainWorkspace.getAllBlocks(),
	    b = [],
	    c = [],
	    d = 0; d < a.length; d++) {
...
Blockly.Procedures.rename = function(a) {
	...
	for (var b = this.sourceBlock_.workspace.getAllBlocks(),
	    c = 0; c < b.length; c++) {
...
Blockly.Procedures.disposeCallers = function(a, b) {
	for (var c = Blockly.Procedures.getCallers(a, b),
	    d = 0; d < c.length; d++)
		c[d].dispose(!0, !1);
	window.setTimeout(Blockly.Procedures.refreshFlyoutCategory, 1)
};
...
Blockly.ScrollbarPair.prototype.resize = function() {
	...
	if (a) {
		var b = !1,
		    c = !1;
		if (this.oldHostMetrics_.viewWidth != a.viewWidth || this.oldHostMetrics_.viewHeight != a.viewHeight || this.oldHostMetrics_.absoluteTop != a.absoluteTop || this.oldHostMetrics_.absoluteLeft != a.absoluteLeft)
			c = b = !0;
		else {
			if (this.oldHostMetrics_.contentWidth != a.contentWidth || this.oldHostMetrics_.viewLeft != a.viewLeft || this.oldHostMetrics_.contentLeft != a.contentLeft)
				b = !0;
			if (this.oldHostMetrics_.contentHeight != a.contentHeight || this.oldHostMetrics_.viewTop != a.viewTop || this.oldHostMetrics_.contentTop != a.contentTop)
				c = !0
		}
		b && this.hScroll.resize(a);
		c && this.vScroll.resize(a);
		this.oldHostMetrics_.viewWidth == a.viewWidth && this.oldHostMetrics_.absoluteLeft == a.absoluteLeft || this.corner_.setAttribute("x", this.vScroll.xCoordinate);
		this.oldHostMetrics_.viewHeight == a.viewHeight && this.oldHostMetrics_.absoluteTop == a.absoluteTop || this.corner_.setAttribute("y", this.hScroll.yCoordinate);
...
Blockly.ScrollbarNative = function(a, b, c, d, e) {
	...
	if (null !== d) {
		...
		d ? (this.foreignObject_.setAttribute("height", Blockly.Scrollbar.scrollbarThickness), this.outerDiv_.style.height = Blockly.Scrollbar.scrollbarThickness + "px", this.outerDiv_.style.overflowX = "scroll", this.outerDiv_.style.overflowY = "hidden", this.innerImg_.style.height = "1px") : (this.foreignObject_.setAttribute("width", Blockly.Scrollbar.scrollbarThickness), this.outerDiv_.style.width = Blockly.Scrollbar.scrollbarThickness + "px", this.outerDiv_.style.overflowX = "hidden", this.outerDiv_.style.overflowY = "scroll", this.innerImg_.style.width = "1px");
		var f = this;
...
Blockly.ScrollbarNative.prototype.resize = function(a) {
	...
	if (this.horizontal_) {
		...
		b = a.viewHeight, this.pair_ ? b -= Blockly.Scrollbar.scrollbarThickness : this.setVisible(b < a.contentHeight), this.ratio_ = b / a.viewHeight,
		c = this.ratio_ * a.contentHeight,
		d = (a.viewTop - a.contentTop) * this.ratio_, this.outerDiv_.style.height = b + "px", this.innerImg_.style.height = c + "px", this.xCoordinate = a.absoluteLeft, Blockly.RTL || (this.xCoordinate += a.viewWidth - Blockly.Scrollbar.scrollbarThickness), this.yCoordinate = a.absoluteTop, this.foreignObject_.setAttribute("x", this.xCoordinate), this.foreignObject_.setAttribute("y", this.yCoordinate), this.foreignObject_.setAttribute("height", Math.max(0, b)), this.outerDiv_.scrollTop = Math.round(d)
};
...
Blockly.Toolbox.createDom = function() {
	...
	var a = Blockly.createSvgElement("g", {}, null);
	Blockly.Toolbox.svgGroup_ = a;
	var b = Blockly.Toolbox.flyout_.createDom();
	a.appendChild(b);
...
Blockly.Toolbox.getMetrics = function() {
	var a = Blockly.svgSize().height,
	    b = Blockly.Toolbox.width;
	try {
		var c = Blockly.Toolbox.svgOptions_.getBBox()
	} catch(d) {
		return null
	}
	return {
...
Blockly.Toolbox.setMetrics = function(a) {
	var b = Blockly.Toolbox.getMetrics();
	goog.isNumber(a.y) && (Blockly.Toolbox.svgOptions_.scrollY = -b.contentHeight * a.y - b.contentTop);
	Blockly.Toolbox.svgOptions_.setAttribute("transform", "translate(0," + (Blockly.Toolbox.svgOptions_.scrollY + b.absoluteTop) + ")")
};
Blockly.Toolbox.init = function() {
	Blockly.Toolbox.flyout_.init(Blockly.mainWorkspace, Blockly.getMainWorkspaceMetrics, !0);
...
Blockly.Toolbox.position_ = function() {
	var a = Blockly.svgSize();
	Blockly.RTL && Blockly.Toolbox.svgGroup_.setAttribute("transform", "translate(" + (a.width - Blockly.Toolbox.width) + ",0)")
};
Blockly.Toolbox.PREFIX_ = "cat_";
Blockly.Toolbox.buildTree_ = function() {
	var a = {},
	    b;
	for (b in Blockly.Language) {
		var c = Blockly.Language[b];
		c.category && ( c = Blockly.Toolbox.PREFIX_ + window.encodeURI(c.category), c in a ? a[c].push(b) : a[c] = [b])
	}
	return a
};
Blockly.Toolbox.redraw = function() {
	function a(a) {
		return function(b) {
			...
			Blockly.hideChaff();
			c == a ? Blockly.Toolbox.clearSelection() : Blockly.Toolbox.selectOption_(a);
			b.stopPropagation()
		}
	}
	...
	var b = [],
	    c;
	for (c in Blockly.Toolbox.languageTree) {
		var d = {};
		d.text = window.decodeURI(c.substring(Blockly.Toolbox.PREFIX_.length));
		d.cat = c;
		b.push(d)
	}
	d = {};
	(Blockly.Language.variables_get || Blockly.Language.variables_set) && b.push({
		text : Blockly.MSG_VARIABLE_CATEGORY,
		cat : Blockly.MSG_VARIABLE_CATEGORY
	});
	(Blockly.Language.procedures_defnoreturn || Blockly.Language.procedures_defreturn) && b.push({
		text : Blockly.MSG_PROCEDURE_CATEGORY,
		cat : Blockly.MSG_PROCEDURE_CATEGORY
	});
	goog.dom.removeChildren(Blockly.Toolbox.svgOptions_);
	c = 0;
	for (var e = [Blockly.Toolbox.svgBackground_],
	    f = 0; d = b[f]; f++) {
		var g = Blockly.ContextMenu.optionToDom(d.text),
		    h = g.firstChild,
		    k = g.lastChild;
		Blockly.Toolbox.svgOptions_.appendChild(g);
		g.setAttribute("transform", "translate(0, " + (f * Blockly.ContextMenu.Y_HEIGHT + 4) + ")");
		g.cat = d.cat;
		Blockly.bindEvent_(g, "mousedown", null, a(g));
		e.push(h);
		c = Math.max(c, k.getComputedTextLength())
	}
	c += 2 * Blockly.ContextMenu.X_PADDING;
	for ( f = 0; f < e.length; f++)
		e[f].setAttribute("width", c);
	if (Blockly.RTL)
		for ( f = 0; g = Blockly.Toolbox.svgOptions_.childNodes[f]; f++)
			k = g.lastChild, k.setAttribute("text-anchor", "end"), k.setAttribute("x", c - Blockly.ContextMenu.X_PADDING);
	Blockly.Toolbox.width = c;
	Blockly.bindEvent_(Blockly.Toolbox.svgGroup_, "mousedown", null, function(a) {
		Blockly.isRightButton(a) && (Blockly.hideChaff(!0), a.stopPropagation())
	});
	Blockly.fireUiEvent(window, "resize")
};
Blockly.Toolbox.selectOption_ = function(a) {
	Blockly.Toolbox.clearSelection();
	if (Blockly.Toolbox.selectedOption_ = a)
		Blockly.addClass_(a, "blocklyMenuSelected"),
		a = a.cat, Blockly.Toolbox.flyout_.show(Blockly.Toolbox.languageTree[a] || a)
};
Blockly.Toolbox.clearSelection = function() {
	var a = Blockly.Toolbox.selectedOption_;
	a && (Blockly.removeClass_(a, "blocklyMenuSelected"), Blockly.Toolbox.selectedOption_ = null);
...
Blockly.Tooltip.onMouseMove_ = function(a) {
	if (Blockly.Tooltip.element_ && Blockly.Tooltip.element_.tooltip && !(Blockly.ContextMenu && Blockly.ContextMenu.visible || 0 != Blockly.Block.dragMode_))
		if (Blockly.Tooltip.visible) {
			...
			Blockly.Tooltip.poisonedElement_ != Blockly.Tooltip.element_ && (window.clearTimeout(Blockly.Tooltip.showPid_), Blockly.Tooltip.lastX_ = a.clientX, Blockly.Tooltip.lastY_ = a.clientY, Blockly.Tooltip.showPid_ = window.setTimeout(Blockly.Tooltip.show_, Blockly.Tooltip.HOVER_MS))
};
...
Blockly.Tooltip.show_ = function() {
	...
	if (Blockly.Tooltip.svgGroup_) {
		...
		if (Blockly.RTL)
			for (var c = a.width,
			    d = 0,
			    e; e = Blockly.Tooltip.svgText_.childNodes[d]; d++)
...
Blockly.Trashcan.prototype.BODY_URL_ = "media/trashbody.svg";
Blockly.Trashcan.prototype.LID_URL_ = "media/trashlid.svg";
...
Blockly.Trashcan.prototype.setOpen_ = function(a) {
	this.isOpen != a && (window.clearTimeout(this.lidTask_), this.isOpen =
	a, Blockly.Trashcan.animateLid_(this))
};
Blockly.Trashcan.animateLid_ = function(a) {
	a.lidAngle_ += a.isOpen ? 10 : -10;
	a.lidAngle_ = Math.max(0, a.lidAngle_);
	a.svgLid_.setAttribute("transform", "rotate(" + (Blockly.RTL ? -a.lidAngle_ : a.lidAngle_) + ", " + (Blockly.RTL ? 4 : a.WIDTH_ - 4) + ", " + (a.LID_HEIGHT_ - 2) + ")");
	if (a.isOpen ? 45 > a.lidAngle_ : 0 < a.lidAngle_)
		a.lidTask_ = window.setTimeout(function() {
			Blockly.Trashcan.animateLid_(a)
		}, 5)
};
Blockly.Trashcan.close = function(a) {
	a.setOpen_(!1)
};
...
Blockly.Variables.allVariables = function(a) {
	...
	for (var c = 0; c < b.length; c++) {
		var d = b[c].getVars;
		if (d)
			for (var d = d.call(b[c]),
			    e = 0; e < d.length; e++) {
				var f = d[e];
				f && (a[Blockly.Names.PREFIX_ + f.toLowerCase()] = {
					name : f,
					type : "Number"
				})
			}
...
Blockly.Variables.renameVariable = function(a, b) {
	for (var c = Blockly.mainWorkspace.getAllBlocks(),
	    d = 0; d < c.length; d++) {
		var e = c[d].renameVar;
		e && e.call(c[d], a, b)
	}
...
Blockly.Variables.flyoutCategory = function(a, b, c, d) {
	...
	if (Blockly.Language.variables_declare) {
		var g = new Blockly.Block(d, "variables_declare");
		g.initSvg();
		a.push(g);
		b.push(2 * c)
	}
	for ( g = 0; g < e.length; g++)
		if (null == e[g] || e[g].name !== f) {
			...
			k && k.initSvg();
			null === e[g] ? f = (h||k).getVars()[0] : (h && h.setTitleValue(e[g].name, "VAR"), k && k.setTitleValue(e[g].name, "VAR"));
			k && a.push(k);
			h && a.push(h);
	...
	if (a.length) {
		...
		for (var c = 0,
			...
			for ( f = !1; e < a.length && !f; )
				a[e].name.toLowerCase() == d && ( f = !0), e++;
			f ? ("z" === d[0] ? (c++,
			d = "a") : ( d = String.fromCharCode(d.charCodeAt(0) + 1), "l" == d[0] && ( d = String.fromCharCode(d.charCodeAt(0) + 1))), 0 < c && (d += c)) : b = d
		}
	} else
		b = "i";
	return b
...
Blockly.Warning.prototype.setVisible = function(a) {
	if (a != this.isVisible())
		if (a) {
			...
			if (Blockly.RTL)
				for (var b = a.getBBox().width,
				    c = 0,
				    d; d = a.childNodes[c]; c++)
...
Blockly.Workspace.prototype.addTrashcan = function(a) {
	Blockly.Trashcan && this.editable && (this.trashcan = new Blockly.Trashcan(a),
	a = this.trashcan.createDom(), this.svgGroup_.insertBefore(a, this.svgBlockCanvas_), this.trashcan.init())
};
...
Blockly.Workspace.prototype.highlightBlock = function(a) {
	this.traceOn_ && ( a = this.getBlockById(a)) && (this.traceOn(!1), a.select(), this.traceOn(!0))
};
	...
	if (!isNaN(c) && !isNaN(a)) {
		...
		do
			for (var d = !1,
			    ...
			    f = 0,
			    g; g = e[f]; f++)
				g = g.getRelativeToSurfaceXY(), 1 >= Math.abs(c - g.x) && 1 >= Math.abs(a - g.y) && ( c = Blockly.RTL ? c - Blockly.SNAP_RADIUS : c + Blockly.SNAP_RADIUS, a += 2 * Blockly.SNAP_RADIUS,
				d = !0);
		while(d);
		b.moveBy(c, a)
	}
...
Blockly.Xml.blockToDom_ = function(a) {
	...
	a.comment && ( c = goog.dom.createDom("comment", null, a.comment.getText()), c.setAttribute("pinned", a.comment.isVisible()),
	d = a.comment.getBubbleSize(), c.setAttribute("h", d.height), c.setAttribute("w", d.width), b.appendChild(c));
	d = !1;
	for ( e = 0; c = a.inputList[e]; e++) {
		var h;
		f = !0;
		c.type != Blockly.DUMMY_INPUT && ( g = c.connection.targetBlock(), c.type == Blockly.INPUT_VALUE ? ( h = goog.dom.createDom("value"),
		d = !0) : c.type == Blockly.NEXT_STATEMENT && ( h = goog.dom.createDom("statement")), g && (h.appendChild(Blockly.Xml.blockToDom_(g)),
		f = !1), h.setAttribute("name", c.name), f || b.appendChild(h))
	}
...
Blockly.Xml.domToBlock_ = function(a, b) {
	...
	for (var d = null,
	    e = 0,
	    f; f = b.childNodes[e]; e++)
		if (3 != f.nodeType || !f.data.match(/^\s*$/)) {
			for (var g = null,
			    h = 0,
			    k; k = f.childNodes[h]; h++)
				3 == k.nodeType && k.data.match(/^\s*$/) || ( g = k);
			...
			case "comment":
				...
				( g = f.getAttribute("pinned")) && c.comment.setVisible("true" == g);
			...
			case "statement":
				f = c.getInput(h);
				if (!f)
					throw "Input does not exist: " + h;
				if (g && "block" == g.nodeName.toLowerCase())
					if ( d = Blockly.Xml.domToBlock_(a, g), d.outputConnection)
						f.connection.connect(d.outputConnection);
					else if (d.previousConnection)
						f.connection.connect(d.previousConnection);
					else
	...
	( e = b.getAttribute("disabled")) && c.setDisabled("true" == e);
	d || c.render();
	return c
};
Blockly.Xml.deleteNext = function(a) {
	for (var b = 0,
	    c; c = a.childNodes[b]; b++)
